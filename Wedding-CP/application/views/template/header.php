        ...
        <nav class="mt-2">
          ...
          ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/tema" class="nav-link <?php if ($this->uri->segment(2) == "tema") {
                                                                                        echo "active";
                                                                                      } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/video" class="nav-link <?php if ($this->uri->segment(2) == "video") {
                                                                                          echo "active";
                                                                                        } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/pengantin" class="nav-link <?php if ($this->uri->segment(2) == "pengantin") {
                                                                                              echo "active";
                                                                                            } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/pembukaan" class="nav-link <?php if ($this->uri->segment(2) == "pembukaan") {
                                                                                              echo "active";
                                                                                            } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/jadwal" class="nav-link <?php if ($this->uri->segment(2) == "jadwal") {
                                                                                          echo "active";
                                                                                        } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/informasi" class="nav-link <?php if ($this->uri->segment(2) == "informasi") {
                                                                                              echo "active";
                                                                                            } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/prewed" class="nav-link <?php if ($this->uri->segment(2) == "prewed") {
                                                                                          echo "active";
                                                                                        } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/pesan" class="nav-link <?php if ($this->uri->segment(2) == "pesan") {
                                                                                          echo "active";
                                                                                        } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/musik" class="nav-link <?php if ($this->uri->segment(2) == "musik") {
                                                                                          echo "active";
                                                                                        } ?>">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url(); ?>konfigurasi/live" class="nav-link <?php if ($this->uri->segment(2) == "live") {
                                                                                        echo "active";
                                                                                      } ?>">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>undangan" class="nav-link <?php if ($this->uri->segment(1) == "undangan") {
                                                                            echo "active";
                                                                          } ?>">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>album" class="nav-link <?php if ($this->uri->segment(1) == "album") {
                                                                          echo "active";
                                                                        } ?>">
