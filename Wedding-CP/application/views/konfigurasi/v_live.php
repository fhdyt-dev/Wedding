              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="custom-select rounded-0" name="platform" id="exampleSelectRounded0">
                    <option value="yt" <?php if ($platform == "yt") {
                                          echo "selected";
                                        } else {
                                        } ?>>Youtube Live</option>
                    <option value="fb" <?php if ($platform == "fb") {
                                          echo "selected";
                                        } else {
                                        } ?>>Facebook Live</option>
                    <option value="ig" <?php if ($platform == "ig") {
                                          echo "selected";
                                        } else {
                                        } ?>>Instragram Live</option>
                    <option value="zoom" <?php if ($platform == "zoom") {
                                            echo "selected";
                                          } else {
                                          } ?>>Zoom</option>
                    <option value="tiktok" <?php if ($platform == "tiktok") {
                                              echo "selected";
                                            } else {
                                            } ?>>Tiktok Live</option>
                    <option value="other" <?php if ($platform == "other") {
                                            echo "selected";
                                          } else {
                                          } ?>>Lainnya...</option>
                  </select>
