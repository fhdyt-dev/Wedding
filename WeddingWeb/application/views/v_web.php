...
<head>
  ...
  <title>Pernikahan <?php echo $detail[0]->KONF_PENGANTIN_PRIA_NAMA; ?> & <?php echo $detail[0]->KONF_PENGANTIN_WANITA_NAMA; ?></title>
      ...
      <div class="container-fluid" data-aos="fade-up">
          ...
          <div class="col-lg-6 jadwal-info">
            <div class="row justify-content-center">
              <div class="col-11 col-lg-8">
                <h3><?php echo $detail[0]->KONF_JADWAL_ACARA1_JUDUL; ?><br><small class="text-muted"><?php echo tanggal($detail[0]->KONF_JADWAL_ACARA1_TANGGAL); ?></small></h3>
        ...
        <div class="row no-gutters mt-4">
          <div class="col-lg-6 jadwal-info">
            <div class="row justify-content-center">
              <div class="col-11 col-lg-8">
                <h3><?php echo $detail[0]->KONF_JADWAL_ACARA2_JUDUL; ?><br><small class="text-muted"><?php echo tanggal($detail[0]->KONF_JADWAL_ACARA2_TANGGAL); ?></small></h3>
        ...
        <div class="row no-gutters supporters-wrap clearfix" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/1.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/2.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/3.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/4.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/5.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/6.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/7.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="<?php echo base_url(); ?>assets/theme/assets/img/supporters/8.png" class="img-fluid" alt="">
            </div>
          </div>
